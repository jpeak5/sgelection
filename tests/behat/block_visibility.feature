...
Feature: Block Visibility
  ...
  Background: Create Election
    ...
    # When first added, no one but admin should see the block.
        ...
        And I follow "My home"
        Then I should see "Student Govt Election"
        And  I should see "Student Govt Election" in the "//div[contains(@class, 'block_sgelection')]//div/h2" "xpath_element"
        ...
        And I should see "Settings" in the "//div[contains(@class, 'block_sgelection')]//a[contains(text(), 'Settings')]" "xpath_element"
        And I log out
    ...
    # When first configured, no one but admin and faculty advisor should see the block
        ...
        And I log in as "facadv001"
        And I follow "My home"
        And I should see "Student Govt Election"
        And I should see "Student Govt Election" in the "//div[contains(@class, 'block_sgelection')]//div/h2" "xpath_element"
        And I should see "Create new election" in the "//div[contains(@class, 'block_sgelection')]//a[contains(text(), 'Create new election')]" "xpath_element"
        And I should see "Settings" in the "//div[contains(@class, 'block_sgelection')]//a[contains(text(), 'Settings')]" "xpath_element"
        And I log out
    ...
    # Note that commissioner should NOT see the 'Settings' link.
        ...
        And I click on "Settings" "link" in the "block_sgelection" "block"
        And I set the following fields to these values:
        ...
        And I should see "Student Govt Election" in the "//div[contains(@class, 'block_sgelection')]//div/h2" "xpath_element"
        And I should see "Create new election" in the "//div[contains(@class, 'block_sgelection')]//a[contains(text(), 'Create new election')]" "xpath_element"
        And I should not see "Settings" in the "//div[contains(@class, 'block_sgelection')]/div" "xpath_element"
        And I log out
